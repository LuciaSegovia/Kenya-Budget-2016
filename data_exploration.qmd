...
1.2. Adaptation of the Energy requirement based on who's eating and the proportion of food eaten using the funcion `Enerc_adjustements()`. Here, the most important is the reduced contribution due to breasfeeding.

1. Exclusive breastfeeding [0-4 months] = 0 kcal.
2. Non-Exclusive breastfeeding [4-23 months] = - kcal
3. Non-xclusive
...
cbind(c(3:12), c(568,636,574,634,714,611,688,635,516,565))
