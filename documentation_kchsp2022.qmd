...
# Data: KENYA CONTINUOUS HOUSEHOLD SURVEY PROGRAMME (KCHSP) 2022"
...
Based on data on WHO/FAO - Here's the energy requirement calculated for each month from 1-6 for the women.
```{r}
